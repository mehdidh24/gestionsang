    ...
    <head> 
        ...
        <body> <div class="container"> 
            <div class="row justify-content-center"> 
                <div class="col-md-5"> <div class="login-container p-5"> 
                    ...
                    <?php if(!empty($error)): ?> 
                            <div class="alert alert-danger alert-dismissible fade show" role="alert"> 
                                <?php echo $error; ?> <button type="button" class="btn-close" data-bs-dismiss="alert">

                                </button> 
                            </div> 
                            <?php endif; ?> 
                            <form method="POST" action="login.php"> 
                                <div class="mb-3"> <label for="nom" class="form-label"> 
                                ...
                                <div class="text-center mt-4"> 
                                    <small class="text-muted"> © 2025 Gestion Sang - Tous droits réservés 
