    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card card-stat bg-danger text-white">
                <div class="card-body">
                    <?php $urgent_count = array_reduce($besoins, fn($n,$b) => $n + ($b['niveau_alerte']==='urgent'),0); ?>
                    <h3><?= $urgent_count ?></h3>
                    <p>Besoins Urgents</p>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card card-stat bg-warning text-dark">
                <div class="card-body">
                    <?php $critique_count = array_reduce($besoins, fn($n,$b) => $n + ($b['niveau_alerte']==='critique'),0); ?>
                    <h3><?= $critique_count ?></h3>
                    <p>Besoins Critiques</p>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card card-stat bg-success text-white">
                <div class="card-body">
                    <?php $normal_count = array_reduce($besoins, fn($n,$b) => $n + ($b['niveau_alerte']==='normal'),0); ?>
                    <h3><?= $normal_count ?></h3>
                    <p>Besoins Normaux</p>
                </div>
            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php foreach($besoins as $b):
                                $badge = ['urgent'=>'danger','critique'=>'warning','normal'=>'success'][$b['niveau_alerte']] ?? 'secondary';
                            ?>
                            <tr class="urgence-<?= $b['niveau_alerte'] ?>">
        ...
        <div class="modal-content">
            <form method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="ajouter_besoin" class="btn btn-primary">Enregistrer</button>
                </div>
            </form>
        </div>
    </div>
